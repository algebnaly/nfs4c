...
class NFS4OpenOptions {
    ...
    fun read(): NFS4OpenOptions {
        this.openOptions = this.openOptions.or(1.shl(0))
        return this
    }

    fun write(): NFS4OpenOptions {
        this.openOptions = this.openOptions.or(1.shl(1))
        return this
    }

    fun create(): NFS4OpenOptions {
        this.openOptions = this.openOptions.or(1.shl(2))
        return this
    }

    fun truncate(): NFS4OpenOptions {
        this.openOptions = this.openOptions.or(1.shl(3))
        return this
    }
